...
export function FloatingChatButton({ onClick }: FloatingChatButtonProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="relative flex h-14 w-14 items-center justify-center rounded-full bg-accent text-white shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
    >
      <motion.span
